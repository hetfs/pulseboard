...
export default function PythonChecklist() {
  const storageKey = 'python-checklist';
  const { width, height } = useWindowSize();
  const audioRef = useRef(null);

  const items = [
    'Understand Python is high-level and readable',
    'Know Python is general-purpose and versatile',
    'Remember indentation defines code blocks',
    'Understand dynamic typing in Python',
    'Recognize Python uses garbage collection',
    'Install Python and add it to PATH',
    'Choose a code editor (VS Code, PyCharm, Neovim, etc.)',
